...
public abstract class ObjectUtil {
    ...
    /**
     * EncodeConvertor the given array (which may be a primitive array) to an object
    ...
    public static int hashCode(String r) {
        Asserter.notNull(r);
     ...
     * @return
     */
    public static <M> M cloneObject(Class<M> clazz, Callback callback) {
     ...
     */
    public static <O> O cloneObject(O o) throws IOException, ClassNotFoundException {
