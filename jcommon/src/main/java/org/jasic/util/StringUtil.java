...
public abstract class StringUtil {
    ...
    public static String DEFAULT_FORMAT_STRING = "yyyyMMddHHmmss";
     ...
     * @return
     */
    public static String getMatch(String inStr, String regex) {
    ...
    /**
     * EncodeConvertor a CSV list into an array of Strings.
     *
     * @param str the input String
    ...
    public static boolean strContainsStr(String str1, String str2) {
    ...
    public static String entityToString(Object o) {
        ...
        Map<String, Object> map = fieldval2Map(o);
     ...
     * @return
     */
    public static String entityToString(Object o, int priority) {

        Map<String, Object> map = fieldval2Map(o, priority);
        return mapToString(map);
    }
     ...
     * @return
     */
    public static String entityToString(Object o, String... args) {

        Map<String, Object> map = fieldval2Map(o, o.getClass(), 0);
        Map<String, Object> result = new HashMap<String, Object>();

        if (args != null) {
            for (String arg : args) {
                result.put(arg, map.get(arg));
            }
        }
     ...
     * @return
     */
    public static Map<String, Object> fieldval2Map(Object obejct, int priority) {
        if (obejct == null) {
            return fieldval2Map(obejct, null, priority);
        }
        return fieldval2Map(obejct, obejct.getClass(), priority);
    }
     ...
     * @return
     */
    public static Map<String, Object> fieldval2Map(Object obejct) {
        if (obejct == null) {
            return fieldval2Map(obejct, 1);
        }
        return fieldval2Map(obejct, 1);
    }
    ...
    public static Map<String, Object> fieldval2Map(Object object, Class<?> current, int priority) {
        ...
        Asserter.isTrue(isBranch, "The specify class is not in the inheritance class tree!");
        try {
            for (Class<?> c : classes) {
     ...
     * @return
     */
    public static boolean isCDMANumber(String str) {
        if (isEmpty(str)) {
            return false;
        }

        return Pattern.compile("1((33|53|8[09])[0-9]|349)\\d{7}").matcher(str.trim()).matches();
    }
     ...
     * @return
     */
    public static boolean hasNotNull(String... strs) {
        if (strs == null) {
            return false;
        }
     ...
     * @return
     */
    public static boolean isAllDate(String formatStr, String[] strs) {
        if (strs == null)
            return false;
    ...
    public static boolean isDate(String str) {
        return isDate(str, DEFAULT_FORMAT_STRING);
    }
     ...
     * @return
     */
    public static boolean isAllDate(String... strs) {
        if (strs == null) {
            return false;
        }
     ...
     * @return
     */
    public static String appendLeftZero(long n, int len) {
        return appendLeftZero(new Long(n).toString(), len);
    }
     ...
     * @return
     */
    public static String appendRightZero(long n, int len) {
        return appendRightZero(new Long(n).toString(), len);
    }
    ...
    public static String appendLeftZero(String str, int len) {
        int strLen = isNull(str) ? 0 : str.length();
        StringBuilder stringBuilder = new StringBuilder();
     ...
     * @return
     */
    public static String appendLeftBlank(int n, int len) {
        return appendLeftBlank(new Integer(n).toString(), len);
    }
     ...
     * @return
     */
    public static String appendRightBlank(int n, int len) {
        return appendRightBlank(new Integer(n).toString(), len);
    }
     ...
     * @return
     */
    public static String appendLeftBlank(long n, int len) {
        return appendLeftBlank(new Long(n).toString(), len);
    }
     ...
     * @return
     */
    public static String appendRightBlank(long n, int len) {
        return appendRightBlank(new Long(n).toString(), len);
    }
     ...
     * @return
     */
    public static String appendLeftBlank(String str, int len) {
        int strLen = isNull(str) ? 0 : str.length();
        StringBuilder stringBuilder = new StringBuilder();
     ...
     * @return
     */
    public static String appendRightBlank(String str, int len) {
        int strLen = isNull(str) ? 0 : str.length();
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append(str);
...
//        System.out.println();
//        System.out.println(mapToString(fieldval2Map(new byte[]{1, 1, 1, 1}, byte[].class)));

        Person person = new Person("Jasic", 27, true, new String[]{"Mesey", "Lossy", "Anni"}, new byte[]{1, 2, 0xf});
        System.out.println(StringUtil.entityToString(person));
        System.out.println(StringUtil.entityToString(person, new String[]{"name", "A", "sex"}));
    }
    ...
    public static class Person {
        ...
        private String[] sexFreind;

        private byte[] m;

        public Person(String name, int age, boolean sex, String[] sexFreind, byte[] m) {
            this.name = name;
            this.age = age;
            this.sex = sex;
            this.sexFreind = sexFreind;
            this.m = m;
        }
        ...
        public String[] getSexFreind() {
            return sexFreind;
        }

        public void setSexFreind(String[] sexFreind) {
            this.sexFreind = sexFreind;
        }
