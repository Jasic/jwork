...
public abstract class CollectionUtil {
    ...
    /**
     * EncodeConvertor the supplied array into a List. A primitive array gets converted
     ...
     *
     * @param referLists
     * @return Map<String,List> key{index1:index2},value: index1 is standard and index2 is to be compared
     */
    public static Map<String, List> findArrayDifferences(List... referLists) {

        Assert.notEmpty(referLists);
        Assert.isTrue(referLists.length >= 2, "数组数量不能小于2");


        Map<String, List> resultMap = new HashMap<String, List>();
        for (int i = 0; i < referLists.length - 1; i++) {
            for (int j = referLists.length - 1; j > i; j--) {
                String key = i + "_" + j;
                List value = findArrayDifference(referLists[i], referLists[j]);
                resultMap.put(key, value);

                key = j +"_" +i;
                value = findArrayDifference(referLists[j],referLists[i]);
                resultMap.put(key,value);
            }
        }
     ...
     * @return
     */
    public static List findArrayDifference(Collection standard, Collection compare) {
    ...
    /**
     * Compare if the contents of this two maps are same
     *
     * @param oldMap
     * @param newMap
     * @return
     */
    public static boolean isSameMap(Map<?, ?> oldMap, Map<?, ?> newMap) {
	...
	public static void main(String[] args) {
        ...
        findArrayDifference(list1,list2);
        Map map = findArrayDifferences(new List[]{list1,list2});
        System.out.println(map);

//
//		Map<List<?>,Set<?>> oldMap = new HashMap<List<?>, Set<?>>();
//		Map<List<?>,Set<?>> newMap = new HashMap<List<?>, Set<?>>();
//		
...
//		set1.add(1);
//		
//		oldMap.put(list1, set1);
//		newMap.put(list1, set1);
//		
//		System.out.println(isSameMap(oldMap, newMap));
	}
}
